...
(function ($) {
    ...
    function SlickGrid(container, data, columns, options) {
        ...
        var $container;
        var $loadingImg; //Mapline_Injected_Code
        ...
        function init() {
            ...
            //Mapline_Injected_Code
            if (options.loadingImage)
                $loadingImg = $(options.loadingImage);
        ...
        //////////////////////////////////////////////////////////////////////////////////////////////
        // Mapline_Injected_Code: Implemented Loading Circle

        function showLoadingImage() {
            if ($loadingImg) {
                var __pos = $container.position();
                $loadingImg
                    .css("position", "absolute")
                    .css("top", __pos.top + $container.height() / 2 - $loadingImg.height() / 2)
                    .css("left", __pos.left + $container.width() / 2 - $loadingImg.width() / 2);
                $loadingImg.show();
            }
        }
